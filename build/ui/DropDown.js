...
export default function DropDown({ disabled = false, buttonLabel, buttonAriaLabel, buttonClassName, buttonIconClassName, children, stopCloseOnClickSelf, hideChevron, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("button", { type: "button", disabled: disabled, "aria-label": buttonAriaLabel || buttonLabel, className: buttonClassName, onClick: handleOnClick, ref: buttonRef, children: [buttonIconClassName && _jsx("span", { className: buttonIconClassName }), buttonLabel && (_jsx("span", { className: "text dropdown-button-text", children: buttonLabel })), !hideChevron && _jsx("i", { className: "chevron-down" })] }), showDropDown &&
                createPortal(_jsx(DropDownItems, { dropDownRef: dropDownRef, onClose: handleClose, autofocus: shouldAutofocus, children: children }), document.body)] }));
}
