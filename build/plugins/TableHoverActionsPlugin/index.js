...
function TableHoverActionsContainer({ anchorElem, }) {
    ...
    return (_jsxs(_Fragment, { children: [isShownRow && (_jsx("button", { className: `${(_a = getTheme()) === null || _a === void 0 ? void 0 : _a.tableAddRows}`, style: Object.assign({}, position), onClick: () => insertAction(true) })), isShownColumn && (_jsx("button", { className: `${(_b = getTheme()) === null || _b === void 0 ? void 0 : _b.tableAddColumns}`, style: Object.assign({}, position), onClick: () => insertAction(false) }))] }));
}
