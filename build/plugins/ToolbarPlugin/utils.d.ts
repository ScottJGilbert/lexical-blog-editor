 ...
 */
export declare const updateFontSizeInSelection: (editor: LexicalEditor, newFontSize: string | null, updateType: UpdateFontSizeType | null, skipRefocus: boolean) => void;
export declare const updateFontSize: (editor: LexicalEditor, updateType: UpdateFontSizeType, inputValue: string, skipRefocus?: boolean) => void;
...
export declare const clearFormatting: (editor: LexicalEditor, skipRefocus?: boolean) => void;
