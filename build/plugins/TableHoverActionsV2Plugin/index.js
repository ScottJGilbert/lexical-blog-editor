...
function getTableFromMouseEvent(event, getTheme) {
    ...
    const tableElement = (_a = cell === null || cell === void 0 ? void 0 : cell.closest("table")) !== null && _a !== void 0 ? _a : null;
    return {
...
function TableHoverActionsV2({ anchorElem, }) {
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (event) => {
            ...
            const rowIndex = hoveredCell.parentElement instanceof HTMLTableRowElement
                ...
                : -1;
            const colIndex = (_a = hoveredCell.cellIndex) !== null && _a !== void 0 ? _a : -1;
            ...
            if (colIndex !== 0) {
                ...
                updateLeft === null || updateLeft === void 0 ? void 0 : updateLeft();
            }
        };
    ...
    const handleSortColumn = (direction) => {
        ...
        editor.update(() => {
            ...
            const headerCell = (_b = (_a = tableMap[0]) === null || _a === void 0 ? void 0 : _a[colIndex]) === null || _b === void 0 ? void 0 : _b.cell;
            const shouldSkipTopRow = (_c = headerCell === null || headerCell === void 0 ? void 0 : headerCell.hasHeader()) !== null && _c !== void 0 ? _c : false;
            ...
            sortableRows.sort((a, b) => {
                ...
                const aMapRow = (_a = tableMap[aRowIndex]) !== null && _a !== void 0 ? _a : [];
                const bMapRow = (_b = tableMap[bRowIndex]) !== null && _b !== void 0 ? _b : [];
                const aCellValue = aMapRow[colIndex];
                const bCellValue = bMapRow[colIndex];
                const aText = (_c = aCellValue === null || aCellValue === void 0 ? void 0 : aCellValue.cell.getTextContent()) !== null && _c !== void 0 ? _c : "";
                const bText = (_d = bCellValue === null || bCellValue === void 0 ? void 0 : bCellValue.cell.getTextContent()) !== null && _d !== void 0 ? _d : "";
            ...
            insertionCaret === null || insertionCaret === void 0 ? void 0 : insertionCaret.splice(0, sortableRows);
        });
    };
    return (_jsxs(_Fragment, { children: [_jsxs("div", { ref: (node) => {
                    floatingElemRef.current = node;
                    refs.setFloating(node);
                }, style: Object.assign(Object.assign({}, floatingStyles), { opacity: isVisible ? 1 : 0 }), className: "floating-top-actions", children: [_jsxs(DropDown, { buttonAriaLabel: "Sort column", buttonClassName: "floating-filter-indicator", hideChevron: true, children: [_jsx(DropDownItem, { className: "item", onClick: () => handleSortColumn("desc"), children: "Sort Ascending" }), _jsx(DropDownItem, { className: "item", onClick: () => handleSortColumn("asc"), children: "Sort Descending" })] }), _jsx("button", { className: "floating-add-indicator", "aria-label": "Add column", type: "button", onClick: handleAddColumn })] }), _jsx("button", { ref: (node) => {
                    leftFloatingElemRef.current = node;
                    leftRefs.setFloating(node);
                }, style: Object.assign(Object.assign({}, leftFloatingStyles), { opacity: isLeftVisible ? 1 : 0 }), className: "floating-add-indicator", "aria-label": "Add row", type: "button", onClick: handleAddRow })] }));
}
