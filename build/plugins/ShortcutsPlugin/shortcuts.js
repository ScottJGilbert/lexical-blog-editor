...
export function isFormatParagraph(event) {
    ...
    return ((code === 'Numpad0' || code === 'Digit0') &&
        isModifierMatch(event, Object.assign(Object.assign({}, CONTROL_OR_META), { altKey: true })));
}
...
export function isFormatNumberedList(event) {
    ...
    return ((code === 'Numpad7' || code === 'Digit7') &&
        isModifierMatch(event, Object.assign(Object.assign({}, CONTROL_OR_META), { shiftKey: true })));
}
